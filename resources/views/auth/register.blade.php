    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="nim" class="block mt-1 w-full" type="text" name="nim" :value="old('nim')"
                required autofocus autocomplete="nim" maxlength="10" />
        ...
        <div>
            ...
            <x-text-input id="no_telp" class="block mt-1 w-full" type="number" name="no_telp" :value="old('no_telp')"
        ...
        <div class="flex flex-col items-center justify-center mt-5 mb-3">
            <button type="submit"
                class="text-white bg-[#4880FF] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-3/4">
                {{ __('Sign in') }}
            </button>
